      ...
      try {
        ...
        const qb = this.dataSource
          ...
          .select([
            ...
            `TO_CHAR(of.start_date, 'YYYY-MM-DD HH24:MI:SS') AS "start_date"`,
            `TO_CHAR(of.end_date, 'YYYY-MM-DD HH24:MI:SS') AS "end_date"`,
            `TO_CHAR(of.breakdown_time, 'YYYY-MM-DD HH24:MI:SS') AS "breakdown_time"`,
            'of.status AS status',
