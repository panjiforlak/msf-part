...
export class Init1753553925213 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "reloc_inbound" ALTER COLUMN "reloc_date" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "reloc_inbound" ALTER COLUMN "reloc_date" SET DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "reloc_inbound" ALTER COLUMN "createdBy" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "reloc_inbound" ALTER COLUMN "updatedBy" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "reloc_inbound" ALTER COLUMN "updatedAt" SET DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "reloc_inbound" ALTER COLUMN "deletedBy" SET NOT NULL`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."components_inventory_type_enum" AS ENUM('others', 'sparepart', 'non-sparepart')`);
        ...
        await queryRunner.query(`ALTER TABLE "reloc_inbound" ADD CONSTRAINT "FK_4457575bcc7861cc465fd05ae09" FOREIGN KEY ("batch_in_id") REFERENCES "batch_inbound"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "reloc_inbound" DROP CONSTRAINT "FK_4457575bcc7861cc465fd05ae09"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."inv_type_old" AS ENUM('others', 'sparepart', 'non-sparepart')`);
        await queryRunner.query(`ALTER TABLE "components" ALTER COLUMN "inventory_type" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "reloc_inbound" ALTER COLUMN "deletedBy" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "reloc_inbound" ALTER COLUMN "updatedAt" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "reloc_inbound" ALTER COLUMN "updatedBy" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "reloc_inbound" ALTER COLUMN "createdBy" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "reloc_inbound" ALTER COLUMN "reloc_date" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "reloc_inbound" ALTER COLUMN "reloc_date" DROP NOT NULL`);
