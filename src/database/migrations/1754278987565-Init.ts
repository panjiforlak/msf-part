...
export class Init1754278987565 implements MigrationInterface {
    name = 'Init1754278987565'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."order_form_status_enum" AS ENUM('pending', 'on progress', 'completed', 'cancelled')`);
        await queryRunner.query(`CREATE TABLE "order_form" ("id" SERIAL NOT NULL, "vehicle_id" integer NOT NULL DEFAULT '0', "admin_id" integer NOT NULL DEFAULT '0', "driver_id" integer NOT NULL DEFAULT '0', "mechanic_id" integer NOT NULL DEFAULT '0', "picker_id" integer NOT NULL DEFAULT '0', "request_id" integer NOT NULL DEFAULT '0', "departement" character varying(255) NOT NULL, "remark" text NOT NULL, "order_type" "public"."order_form_order_type_enum" NOT NULL DEFAULT 'sparepart', "start_date" TIMESTAMP WITH TIME ZONE NOT NULL, "end_date" TIMESTAMP WITH TIME ZONE NOT NULL, "status" "public"."order_form_status_enum" NOT NULL DEFAULT 'pending', "createdby" integer NOT NULL DEFAULT '0', "createdat" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedby" integer NOT NULL DEFAULT '0', "updatedat" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deletedby" integer NOT NULL DEFAULT '0', "deletedat" TIMESTAMP WITH TIME ZONE, "approval_by" integer, "approval_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_8a67a51ec8facd22902fdd8179b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "relocation" ADD "quantity_temp_outbound" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "relocation" ADD "picker_id" integer`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "employee_id" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "sppb" DROP COLUMN "start_date"`);
        await queryRunner.query(`ALTER TABLE "sppb" DROP COLUMN "author"`);
        await queryRunner.query(`ALTER TABLE "relocation" DROP COLUMN "picker_id"`);
        await queryRunner.query(`ALTER TABLE "relocation" DROP COLUMN "quantity_temp_outbound"`);
